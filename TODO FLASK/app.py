...
def updatePassword():
    ...
    return render_template("user_info.html", title="User profile", message=msg, user=getUserStats())
...
def getCompletedTasks():
    ...
    return render_template("completed.html", title="Finished tasks", tasks=usr_inactive_tasks)
...
@app.route("/profile")
def displayProfile():
    return render_template("user_info.html", title="User profile", message="", user=getUserStats())
